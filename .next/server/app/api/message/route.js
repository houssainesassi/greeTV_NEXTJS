...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _supabase_supabase_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @supabase/supabase-js */ \"(rsc)/./node_modules/@supabase/supabase-js/dist/module/index.js\");\n\n\nconst supabase = (0,_supabase_supabase_js__WEBPACK_IMPORTED_MODULE_1__.createClient)(\"https://jshbpasfzgruworxexxk.supabase.co\", \"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpzaGJwYXNmemdydXdvcnhleHhrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1ODE4MjMwNiwiZXhwIjoyMDczNzU4MzA2fQ.EUUXN_mEVCyqBcyEDQfyAhPYDFAu_Md9WbUs25dmaKk\");\nasync function POST(req) {\n    try {\n        const { message, period, period_duration } = await req.json();\n        if (!message || !period) {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: \"Message and period are required\"\n            }, {\n                status: 400\n            });\n        }\n        // نعمل update حسب period\n        const { data, error } = await supabase.from(\"messages\").update({\n            message,\n            period_duration\n        }).eq(\"period\", period) // هذي تحدد الرسالة اللي باش نغيّروها\n        .select();\n        if (error) throw error;\n        // إذا ما كانتش موجودة، نعمل insert (اختياري)\n        if (data.length === 0) {\n            const { data: inserted, error: insertError } = await supabase.from(\"messages\").insert([\n                {\n                    message,\n                    period,\n                    period_duration\n                }\n            ]).select();\n            if (insertError) throw insertError;\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                success: true,\n                data: inserted\n            });\n        }\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            success: true,\n            data\n        });\n    } catch (err) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: err.message\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/message/route.ts\n");
